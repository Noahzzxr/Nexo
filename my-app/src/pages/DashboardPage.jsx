      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 grid gap-6">
          ...
          <Card className="border-brand-royal/20 bg-brand-royal-soft overflow-hidden">
            <div className="grid gap-6 p-6 md:grid-cols-[1.6fr_1fr] md:items-center">
              <div>
                <p className="text-sm font-black uppercase text-brand-royal">Painel Docente</p>
                <h2 className="mt-2 text-3xl font-black text-brand-ink">Rotina do Professor</h2>
                <p className="mt-3 max-w-2xl text-sm text-muted">
                  Acompanhe suas turmas, aulas do dia e trabalhos para correção em um painel alinhado à sua rotina docente.
                </p>
              </div>
              <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-brand-royal/10">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-sm font-black uppercase text-brand-royal">Turmas Ativas</p>
                    <p className="mt-2 text-3xl font-black text-brand-ink">7</p>
                  </div>
                  <Badge className={statStyles.coral.badge}>Ativas</Badge>
                </div>
                <div className="mt-6 grid gap-3 text-sm text-slate-700">
                  <p>17 alunos vinculados</p>
                  <p>3 trabalhos para corrigir</p>
                </div>
              </div>
            </div>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className={`${statStyles.coral.card} overflow-hidden`}>
              <p className={`text-sm font-black uppercase ${statStyles.coral.label}`}>Turmas Ativas</p>
              <div className="mt-4 flex items-end justify-between gap-4">
                <span className="text-4xl font-black text-brand-ink">7</span>
                <Badge className={statStyles.coral.badge}>Aulas</Badge>
              </div>
            </Card>
            <Card className={`${statStyles.royal.card} overflow-hidden`}>
              <p className={`text-sm font-black uppercase ${statStyles.royal.label}`}>Alunos na Grade</p>
              <div className="mt-4 flex items-end justify-between gap-4">
            ...
            <Card className={`${statStyles.success.card} overflow-hidden`}>
              <p className={`text-sm font-black uppercase ${statStyles.success.label}`}>Trabalhos para Corrigir</p>
              <div className="mt-4 flex items-end justify-between gap-4">
                <span className="text-4xl font-black text-brand-ink">3</span>
                <Badge className={statStyles.success.badge}>Urgentes</Badge>
              </div>
            </Card>
          </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="lg:col-span-2 grid gap-6">
        ...
        <Card className="border-brand-royal/20 bg-brand-royal-soft overflow-hidden">
          <div className="grid gap-6 p-6 md:grid-cols-[1.6fr_1fr] md:items-center">
            <div>
              <p className="text-sm font-black uppercase text-brand-royal">Nível de Experiência (XP)</p>
              <h2 className="mt-2 text-4xl font-black text-brand-ink">{currentUser.xp || 370} XP</h2>
              <p className="mt-3 max-w-2xl text-sm text-muted">Nível {currentUser.level || 4} · Estudante dedicado</p>
            </div>
            <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-brand-royal/10">
              <p className="text-sm font-black uppercase text-brand-royal">Progresso do curso</p>
              <div className="mt-4 h-3 overflow-hidden rounded-full bg-page">
                <div className="h-full w-3/4 rounded-full bg-alert-coral" />
              </div>
              <p className="mt-3 text-sm text-slate-600">760 / 1.000 XP</p>
            </div>
          </div>
      ...
      <aside className="grid gap-6">
        <Card>
          <p className="text-sm font-black uppercase text-alert-coral">Mini calendário</p>
